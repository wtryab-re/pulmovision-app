    ...
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.footerNav}>
          <TouchableOpacity onPress={() => router.push('/startscreens/patientDashboard' as any)}>
            <Ionicons name="home-outline" size={width * 0.07} color="#999" />
          </TouchableOpacity>

          <TouchableOpacity onPress={() => router.push('/screens/notifications' as any)}>
...
const styles = StyleSheet.create({
  ...
  profileImage: { width: width * 0.14, height: width * 0.14, borderRadius: (width * 0.2) / 2 },
  resultCard: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  resultValue: { fontSize: width * 0.06, fontWeight: 'bold', color: '#333', textAlign: 'center' },
  detailsContainer: {
    backgroundColor: '#f5f5f5',
  ...
  detailRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: height * 0.025 },
  detailLabel: { fontSize: width * 0.04, color: '#555' },
  detailValue: { fontSize: width * 0.04, color: '#333', fontWeight: '600', textAlign: 'left' },
  backButton: {
  ...
  backButtonText: { color: '#fff', fontSize: width * 0.045, fontWeight: 'bold' },
  footerNav: {
    flexDirection: 'row',
